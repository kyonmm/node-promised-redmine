...
var proto = {
    ...
    if("time_entry" in params && "user" in params.time_entry){
      options.headers["X-Redmine-Switch-User"] = params.time_entry.user
    }
    if("issue" in params && "user" in params.issue){
      options.headers["X-Redmine-Switch-User"] = params.issue.user
    }
	...
	*/
	...
	///wiki
	,getWiki: function(wikiUrl,params){return this.get(wikiUrl,params);}

   ///version
	,getVersions: function(project_id, params){return this.get('projects/' + project_id + '/versions',params);}
	,postVersions: function(project_id, params){return this.post('projects/' + project_id + '/versions',params);}
